...
| **Google Play** | **LIVE listing**, internal track; every upload manual today — CI auto-submit is wired but dormant (`PLAY_SERVICE_ACCOUNT_JSON` unset). | [`play/listing-en-US.md`](play/listing-en-US.md) | [`play/store-ready/`](play/store-ready/) (+ [`MANIFEST.md`](play/store-ready/MANIFEST.md)) | [`dev/google-play-store.md`](../../dev/google-play-store.md) |
