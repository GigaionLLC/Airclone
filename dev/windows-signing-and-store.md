...
| Store ID | set — org variable `STORE_APP_ID`. Not a secret (it is in the public Store URL), and it also appears in `tool/store_submit.py`'s `--app-id` help text and usage example |
