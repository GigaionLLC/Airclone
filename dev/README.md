...
| **Submit to the Mac App Store or the iOS App Store** | [`apple-appstore-and-macos.md`](apple-appstore-and-macos.md) §2 | Per-release runbook, six steps, five of them one `gh workflow run` each. Real IDs and the App Review contact are in the encrypted vault, not here. |
